{**
 * plugins/generic/epubJsViewer/templates/submissionGalley.tpl
 *
...
{include file=$displayTemplateResource title=$submission->getLocalizedTitle() parentUrl=$parentUrl epubUrl=$epubUrl galleyTitle=$galleyTitle datePublished=$datePublished}
